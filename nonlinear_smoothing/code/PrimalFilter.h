 ...
 * 
 *=========================================================================*/ 
#ifndef PrimalFilter_h 
#define PrimalFilter_h 
...
public:
  ...
  itkTypeMacro(PrimalFilter, ImageToImageFilter);
